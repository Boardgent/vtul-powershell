...
<#
  ...
  .Description
    This Cmdlet returns the Intel Active Management Technology(AMT) core firmware version from clients that have Intel Active Management Technology firmware version 3.2 or higher.
  .Notes
  ...
  .Link
    ...
    http:\\www.intel.com
  .Example
    Get-AMTFirmwareVersion -computername:vProClient
...
PROCESS {
	...
	ForEach ($Comp in $ComputerName) {
		...
		try{
			...
			$buildNum = Get-itemproperty $tempAMTPSDrive":\Config\Etc\CodeVersions\Recovery Build Num" -name Value
			
			Get-Item $tempAMTPSDrive":\Config\Etc\CodeVersions\AMT FW Core Version" | ForEach-Object {        

			$obj | Add-Member -MemberType noteproperty -Name Property -value $_.Name
			$entireNum = [String]$_.Value + "." + $buildnum
			$obj | Add-Member -MemberType noteproperty -Name Value -value $entireNum
			...
			{
				$obj | Add-Member -MemberType noteproperty -Name Property -value "Error"
				$obj | Add-Member -MemberType noteproperty -Name Value -value "Unauthorized"				
			}
			 else							
			{
				$obj | Add-Member -MemberType noteproperty -Name Property -value "Error"
				$obj | Add-Member -MemberType noteproperty -Name Value -value "Cannot connect"	
			}
			$Results += $obj
		}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUk6wCOg99RdN02HRDRCivRE0f
# +OigghW+MIIDPTCCAqagAwIBAgIDBbD/MA0GCSqGSIb3DQEBBQUAME4xCzAJBgNV
...
# DAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUqxO3jdup4faGezTdZAdR6tyC
# KPowDQYJKoZIhvcNAQEBBQAEgYCACN5PSABvNLrzpIe7okH3fdw0Wg3HuUDXSV6J
# 4VrocYRu5jXLpCH0YMRr7+DMZCFDhPlqhLAYEBbc/g+VCYOa6WZEB4l+lVGR4MfK
# NFLUEmPyMCnC4ZbqpKzwvXXDyxMSmWgrtf6zFF51QImjtU9/XCSamvmPBF9qeG+H
# 7LumEaGCAX8wggF7BgkqhkiG9w0BCQYxggFsMIIBaAIBATBnMFMxCzAJBgNVBAYT
...
# DxcNMTIwMTE5MjMxNzMzWjAjBgkqhkiG9w0BCQQxFgQU8UYtydYbirYs1Oatgh8K
# oR0u1B8wDQYJKoZIhvcNAQEBBQAEgYBkqfRgWYWflNdC2QfDsbGy3WLBE9i+TD/D
# Ga5D7E+dnaEMLG9wlsEOHb5bOOAJ/e78VfwQWzP7WvsyAjBRtSZZUqNeqmj1kHRM
# buQaEjFcZx74nzvLIyQzR0Fs+wj59I1SzmQ5Fe6uOP3hAKzzMW1yr02eWz0YBhSa
# kQFIjMgmcA==
