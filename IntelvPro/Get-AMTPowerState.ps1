...
<#
  ...
  .Example
    Get-AMTPowerState -computername:vproclient.vprodemo.com -credential $AMTCredential -TLS
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUIMLsSIrRkD078nJYfmOOut60
# /x+gghW+MIIDPTCCAqagAwIBAgIDBbD/MA0GCSqGSIb3DQEBBQUAME4xCzAJBgNV
...
# DAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUzD/tPTp1ZNvKEZ1ZyTYAiYkE
# UeEwDQYJKoZIhvcNAQEBBQAEgYBDo8lycGEOgz2SIJr/yRXE6kcOoX3ttTzPA7aO
# 9ETogD4jUIWKTWGGoVxLVLgzf8MA1DMi8eFhsTF7JROgy5i3trBFLzMbggxHRCJF
# Ldv5+DartxdIYB0OdJM4tpMSa6CuzOJqWmWLpE7OAwbbCijg7jUT0W0VjT86d/pk
# 06kUBaGCAX8wggF7BgkqhkiG9w0BCQYxggFsMIIBaAIBATBnMFMxCzAJBgNVBAYT
...
# DxcNMTIwMTE5MjMxNzMyWjAjBgkqhkiG9w0BCQQxFgQUBMdzzaVV0ZBHH61VpqXJ
# Ew2hGrcwDQYJKoZIhvcNAQEBBQAEgYAJPQ//WJgdAcuXg6hxdkTGUKRxGCc+/o/i
# xOdhKwqbnWY+bdAO+Ri6TjN5j0CxnPAzeMcRy9cM6Slet6+0mWzzyE0aprs7TPAT
# DTkcLT76V6B47FKV1x38FTd8sE/X7c5UVyTUEMwOe9i1t1/Uw2RZULjqg0MlFOnl
# wJAil+L12g==
