Export-CertForAMT -DestinationPath:$env:TEMP\Certs.PEM -NoOutput $true

try {
Set-Content $env:TEMP\cd.iso -Value ""
Set-Content $env:TEMP\floppy.img -Value ""
Copy $psScriptRoot\MC.ini $env:TEMP
} catch {}

# SIG # Begin signature block
# MIIZUwYJKoZIhvcNAQcCoIIZRDCCGUACAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU1JnZ1LWhH2abiDQUCQhOrx+g
# VxCgghW+MIIDPTCCAqagAwIBAgIDBbD/MA0GCSqGSIb3DQEBBQUAME4xCzAJBgNV
...
# DAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUXKBROf79Pf6siJEktgBbwllz
# PCYwDQYJKoZIhvcNAQEBBQAEgYBHD0XfO/KgHgiunM6jMCvkd9AcOkpRLXBcGMfj
# kKYisp4j5O+TTTDaAM5VXcKTeVFnJVLTgFp2qw0/aYfWuNUFqSvIiN5aPvTSFJWe
# lfswADJs+Dsu/Vgvc0w8zJ8Nfzv/s1z+b5F/T8Z1xzn5VEsjweQeifkcXz/e+a4g
# u3kDQ6GCAX8wggF7BgkqhkiG9w0BCQYxggFsMIIBaAIBATBnMFMxCzAJBgNVBAYT
...
# DxcNMTIwMTE5MjMxNzI5WjAjBgkqhkiG9w0BCQQxFgQUjkKwz6l3ez0x6sbbnXhk
# tK3NK1QwDQYJKoZIhvcNAQEBBQAEgYBtr4yeHWsyTskjXlMJpkbm6y1uzfQOTqKp
# tOi2fOjpnAT9Ag5+H3uqpC3RmFVyh8PA1s5jagVxD7Iky+Rkr5A/LBm24a3PJ+IQ
# RLc4rIEOboGvUoyeEFvesbZ9E8jUYEcz75gVhQ8x3rwJ4pDyFGydBtjOhOdMb1UK
# WMzxdEGAuA==
