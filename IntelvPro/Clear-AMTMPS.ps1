 Function clear-AMTMPS {
<#
  .Synopsis 
    Clears the Intel Fast Call for Help Management Presence Server (MPS) interface settings 
  .Description
    Clears the status of the Intel Fast Call for Help Management Presence Server (MPS) interface settings 
  .Notes
...
write-output "MPS settings cleared"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUE5hwQUfpPNPauNvkAscxxUWh
# OaegghW+MIIDPTCCAqagAwIBAgIDBbD/MA0GCSqGSIb3DQEBBQUAME4xCzAJBgNV
...
# DAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUiI7uJVaWfvfI2hr3NELEVMu/
# 8nEwDQYJKoZIhvcNAQEBBQAEgYCEpO1dGJ+lCZgAKFcu7M+ZW/mUgw1o9IELKCg7
# 0W0NSuGeXqufBDpsicixxr3diDwykKVqedizSrG2YAwLuj9o6VGFa4XgcMY9ABm5
# obF777nEvlkq5wq4AOkfobkqZI91KEDBVw/+0kPru9A0yWHzlaKQtsrfbQ0rC6Ba
# rDFkgaGCAX8wggF7BgkqhkiG9w0BCQYxggFsMIIBaAIBATBnMFMxCzAJBgNVBAYT
...
# DxcNMTIwMTE5MjMxNzQwWjAjBgkqhkiG9w0BCQQxFgQUpmq4v8/PwJUCQN14b2SA
# 19H/oZIwDQYJKoZIhvcNAQEBBQAEgYBSQX6meknUsbNJNa+m88tY5tINS3IYNDus
# LZm8qjKPfzF2qXLNRcrpMPozMr9hXJSQe1DcnIuHXnY4VF8tdcSSguJf5w79lwbH
# rFFujxowY5sMGSwDozsazNuYTgNXvP3RT6/GVKEy0n4YgggPEgAKdzTUVDQpkakW
# lF2vLRRBBQ==
